<div class="container">
    ...
    <div class="row">
        ...
        <a href="<?= base_url('master_customers/create') ?>" class="btn btn-primary disabled" >Create</a>
        </div>
    </div>
</div>

<?php echo form_open(base_url('master_customers/update/' . $row->id_pelanggan)); ?>
<div class="mb-3">
<div class="mb-3">
  <div class="text-danger"><?php echo form_error('inputCustomerName'); ?></div>
    ...
    <input type="text" class="form-control"  placeholder="Customer Name" id="inputCustomerName" name="inputCustomerName" value="<?= $row->nama_pelanggan ?>">
  </div>
  
  <div class="mb-3">
  <div class="text-danger"><?php echo form_error('inputTelp'); ?></div>
    <label for="inputTelp" class="form-label">Telp</label>
    <input type="number" class="form-control"  placeholder="Telp" id="inputTelp" name="inputTelp" value="<?= $row->telp_pelanggan ?>">
  </div>

  <div class="mb-3">
  <label for="inputAddress">Address</label>
  <textarea class="form-control" placeholder="Customer Address" id="inputAddress" name="inputAddress"><?= $row->alamat_pelanggan ?></textarea>
  </div>
