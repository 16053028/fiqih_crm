...
-- Dumping database structure for fiqih_crm
CREATE DATABASE IF NOT EXISTS `fiqih_crm` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `fiqih_crm`;
...
-- Dumping data for table fiqih_crm.tbl_layanan: ~0 rows (approximately)
...
-- Dumping data for table fiqih_crm.tbl_login: ~6 rows (approximately)
INSERT INTO `tbl_login` (`id_login`, `username`, `password`, `id_level`, `created_at`, `last_login`, `last_modified`, `deleted`) VALUES
	...
	(2, 'superadm', '$2y$10$xDMhVpMiz2edGh2jzL47VODdQuH9X9QyniPB7/ONwUNwVWcGPQgIe', 1, '2025-02-26 09:32:52', '2025-02-26 10:51:04', '2025-02-26 17:51:04', 0),
	(3, 'sales1', '$2y$10$l8pBQwCx7f96EYd6.oT4uuPzOxiP7GdtkwNahhF/st5TyPbluLT6e', 3, '2025-02-26 09:33:11', '2025-02-26 10:33:40', '2025-02-26 17:33:40', 0),
	(4, 'manager1', '$2y$10$3POg7OgeN07MC1KfKYvUy.2WGu3gWrcaCF377v1NO4ysVSPjQ7yyi', 2, '2025-02-26 09:33:32', '2025-02-26 10:43:22', '2025-02-26 17:43:22', 0);
...
CREATE TABLE IF NOT EXISTS `tbl_pelanggan` (
  ...
  `telp_pelanggan` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '',
